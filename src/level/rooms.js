...
function buildRoom3() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'saw_blade', x: 15, y: 10, axis: 'x', range: 96, speed: 1.0, phase: 0 },
      { type: 'fireball_shooter', x: 1, y: 8, dir: 'right', interval: 2500 },
      { type: 'floor_spikes', x: 22, y: 19, onTime: 1400, offTime: 2200, phase: 0 },
      { type: 'floor_spikes', x: 35, y: 19, onTime: 1400, offTime: 2200, phase: 700 },
      { type: 'flame_jet', x: 20, y: 19, dir: 'up', onTime: 1100, offTime: 2000, phase: 0 }
    ],
    foreground: [
...
function buildRoom4() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'saw_blade', x: 25, y: 8, axis: 'y', range: 80, speed: 1.2, phase: 0 },
      { type: 'fireball_shooter', x: 48, y: 10, dir: 'left', interval: 2200 },
      { type: 'fireball_shooter', x: 1, y: 14, dir: 'right', interval: 2600 },
      { type: 'floor_spikes', x: 18, y: 19, onTime: 1300, offTime: 2000, phase: 0 },
      { type: 'floor_spikes', x: 38, y: 19, onTime: 1300, offTime: 2000, phase: 650 },
      { type: 'flame_jet', x: 32, y: 2, dir: 'down', onTime: 1400, offTime: 1600, phase: 0 }
    ],
    foreground: [
...
function buildRoom5() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'crawler', x: 7, y: 20 },
      { type: 'crawler', x: 33, y: 20 },
      ...
      { type: 'pendulum_trap', x: 20, y: 4, length: 80, swing: 50, speed: 2.0, phase: 0.8 },
      ...
      { type: 'floor_spikes', x: 14, y: 21, onTime: 1200, offTime: 2400, phase: 0 },
      { type: 'floor_spikes', x: 28, y: 21, onTime: 1200, offTime: 2400, phase: 600 },
      { type: 'fireball_shooter', x: 38, y: 6, dir: 'left', interval: 2800 },
      { type: 'saw_blade', x: 20, y: 12, axis: 'x', range: 80, speed: 0.9, phase: 0 },
      { type: 'flame_jet', x: 10, y: 2, dir: 'down', onTime: 1000, offTime: 2000, phase: 400 }
    ],
    foreground: [
      { type: 'fg_rock_formation', x: 0, y: H - 1, flipX: false },
      { type: 'fg_rock_formation', x: W - 2, y: H - 1, flipX: true },
...
function buildRoom6() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'saw_blade', x: 20, y: 10, axis: 'x', range: 128, speed: 1.1, phase: 0 },
      { type: 'saw_blade', x: 42, y: 14, axis: 'y', range: 64, speed: 1.3, phase: 1.5 },
      { type: 'fireball_shooter', x: 1, y: 8, dir: 'right', interval: 2200 },
      { type: 'fireball_shooter', x: 58, y: 12, dir: 'left', interval: 2400 },
      { type: 'floor_spikes', x: 30, y: 19, onTime: 1500, offTime: 1800, phase: 0 },
      { type: 'floor_spikes', x: 48, y: 19, onTime: 1500, offTime: 1800, phase: 900 },
      { type: 'flame_jet', x: 15, y: 19, dir: 'up', onTime: 1200, offTime: 1600, phase: 0 },
      { type: 'flame_jet', x: 50, y: 2, dir: 'down', onTime: 1000, offTime: 2000, phase: 600 }
    ],
    foreground: [
      { type: 'fg_rock_formation', x: 0, y: H - 1, flipX: false },
      { type: 'fg_rock_formation', x: W - 2, y: H - 1, flipX: true },
...
function buildRoom7() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'fireball_shooter', x: 1, y: 10, dir: 'right', interval: 2400 },
      { type: 'fireball_shooter', x: 28, y: 18, dir: 'left', interval: 2800 },
      { type: 'floor_spikes', x: 14, y: 25, onTime: 1200, offTime: 2000, phase: 0 },
      { type: 'saw_blade', x: 15, y: 14, axis: 'y', range: 64, speed: 1.0, phase: 0 },
      { type: 'flame_jet', x: 8, y: 25, dir: 'up', onTime: 1100, offTime: 1900, phase: 300 }
    ],
    foreground: [
      { type: 'fg_rock_formation', x: 0, y: H - 1, flipX: false },
      { type: 'fg_rock_formation', x: W - 2, y: H - 1, flipX: true },
...
function buildRoom8() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'hanging_moss', x: 36, y: 2 },
      { type: 'saw_blade', x: 18, y: 10, axis: 'x', range: 96, speed: 1.2, phase: 0 },
      { type: 'saw_blade', x: 35, y: 18, axis: 'y', range: 80, speed: 1.0, phase: 1.0 },
      { type: 'fireball_shooter', x: 1, y: 6, dir: 'right', interval: 2000 },
      { type: 'fireball_shooter', x: 48, y: 14, dir: 'left', interval: 2200 },
      { type: 'floor_spikes', x: 12, y: 23, onTime: 1300, offTime: 1800, phase: 0 },
      { type: 'floor_spikes', x: 30, y: 23, onTime: 1300, offTime: 1800, phase: 650 },
      { type: 'floor_spikes', x: 42, y: 23, onTime: 1300, offTime: 1800, phase: 1300 },
      { type: 'flame_jet', x: 24, y: 2, dir: 'down', onTime: 1400, offTime: 1400, phase: 0 }
    ],
    foreground: [
      { type: 'fg_rock_formation', x: 0, y: H - 1, flipX: false },
      { type: 'fg_rock_formation', x: W - 2, y: H - 1, flipX: true },
...
function buildRoom10() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'saw_blade', x: 15, y: 8, axis: 'x', range: 112, speed: 1.3, phase: 0 },
      { type: 'saw_blade', x: 38, y: 14, axis: 'y', range: 72, speed: 1.1, phase: 2.0 },
      { type: 'fireball_shooter', x: 1, y: 10, dir: 'right', interval: 2000 },
      { type: 'fireball_shooter', x: 48, y: 6, dir: 'left', interval: 2200 },
      ...
      { type: 'flame_jet', x: 30, y: 19, dir: 'up', onTime: 1300, offTime: 1500, phase: 0 },
      { type: 'flame_jet', x: 20, y: 2, dir: 'down', onTime: 1100, offTime: 1900, phase: 500 }
    ],
    foreground: [
      { type: 'fg_crystal_large', x: 0, y: H - 1, flipX: false },
      { type: 'fg_crystal_large', x: W - 1, y: H - 1, flipX: true },
...
function buildRoom11() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'vine', x: 14, y: 1 },
      { type: 'fireball_shooter', x: 1, y: 8, dir: 'right', interval: 2200 },
      { type: 'fireball_shooter', x: 22, y: 16, dir: 'left', interval: 2600 },
      { type: 'fireball_shooter', x: 1, y: 22, dir: 'right', interval: 3000 },
      { type: 'floor_spikes', x: 12, y: 27, onTime: 1100, offTime: 1900, phase: 0 },
      { type: 'saw_blade', x: 12, y: 12, axis: 'y', range: 64, speed: 1.2, phase: 0 },
      { type: 'flame_jet', x: 18, y: 6, dir: 'down', onTime: 1200, offTime: 1600, phase: 200 }
    ],
    foreground: [
      { type: 'fg_crystal_large', x: 0, y: H - 1, flipX: false },
      { type: 'fg_crystal_large', x: W - 1, y: H - 1, flipX: true },
...
function buildRoom12() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'saw_blade', x: 18, y: 8, axis: 'x', range: 128, speed: 1.2, phase: 0 },
      { type: 'saw_blade', x: 40, y: 14, axis: 'x', range: 96, speed: 1.0, phase: 1.5 },
      { type: 'fireball_shooter', x: 1, y: 10, dir: 'right', interval: 2000 },
      { type: 'fireball_shooter', x: 53, y: 8, dir: 'left', interval: 2200 },
      { type: 'floor_spikes', x: 14, y: 19, onTime: 1200, offTime: 1600, phase: 0 },
      { type: 'floor_spikes', x: 28, y: 19, onTime: 1200, offTime: 1600, phase: 400 },
      { type: 'floor_spikes', x: 44, y: 19, onTime: 1200, offTime: 1600, phase: 800 },
      { type: 'flame_jet', x: 22, y: 2, dir: 'down', onTime: 1300, offTime: 1500, phase: 0 },
      { type: 'flame_jet', x: 36, y: 19, dir: 'up', onTime: 1100, offTime: 1700, phase: 600 }
    ],
    foreground: [
      { type: 'fg_crystal_large', x: 0, y: H - 1, flipX: false },
      { type: 'fg_crystal_large', x: W - 1, y: H - 1, flipX: true },
...
function buildRoom13() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'fireball_shooter', x: 1, y: 12, dir: 'right', interval: 2000 },
      { type: 'fireball_shooter', x: 38, y: 8, dir: 'left', interval: 2400 },
      ...
      { type: 'flame_jet', x: 16, y: 21, dir: 'up', onTime: 1200, offTime: 1400, phase: 0 },
      { type: 'flame_jet', x: 34, y: 2, dir: 'down', onTime: 1000, offTime: 1800, phase: 400 }
    ],
    foreground: [
      { type: 'fg_crystal_large', x: 0, y: H - 1, flipX: false },
      { type: 'fg_crystal_large', x: W - 1, y: H - 1, flipX: true },
...
function buildRoom14() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'saw_blade', x: 15, y: 12, axis: 'x', range: 112, speed: 1.4, phase: 0 },
      { type: 'saw_blade', x: 36, y: 8, axis: 'y', range: 96, speed: 1.2, phase: 1.0 },
      { type: 'fireball_shooter', x: 1, y: 8, dir: 'right', interval: 1800 },
      { type: 'fireball_shooter', x: 48, y: 16, dir: 'left', interval: 2000 },
      { type: 'floor_spikes', x: 20, y: 23, onTime: 1000, offTime: 1600, phase: 0 },
      { type: 'floor_spikes', x: 32, y: 23, onTime: 1000, offTime: 1600, phase: 500 },
      { type: 'floor_spikes', x: 44, y: 23, onTime: 1000, offTime: 1600, phase: 1000 },
      { type: 'flame_jet', x: 26, y: 2, dir: 'down', onTime: 1200, offTime: 1200, phase: 0 },
      { type: 'flame_jet', x: 40, y: 23, dir: 'up', onTime: 1400, offTime: 1400, phase: 600 }
    ],
    foreground: [
      { type: 'fg_rock_formation', x: 0, y: H - 1, flipX: false },
      { type: 'fg_rock_formation', x: W - 2, y: H - 1, flipX: true },
...
function buildRoom15() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'vine', x: 10, y: 1 },
      { type: 'vine', x: 22, y: 1 },
      { type: 'fireball_shooter', x: 1, y: 8, dir: 'right', interval: 2000 },
      { type: 'fireball_shooter', x: 28, y: 14, dir: 'left', interval: 2200 },
      { type: 'fireball_shooter', x: 1, y: 20, dir: 'right', interval: 2400 },
      { type: 'floor_spikes', x: 14, y: 25, onTime: 1000, offTime: 1600, phase: 0 },
      { type: 'saw_blade', x: 15, y: 10, axis: 'y', range: 72, speed: 1.3, phase: 0 },
      { type: 'flame_jet', x: 8, y: 4, dir: 'down', onTime: 1100, offTime: 1500, phase: 0 },
      { type: 'flame_jet', x: 22, y: 25, dir: 'up', onTime: 1300, offTime: 1300, phase: 500 }
    ],
    foreground: [
      { type: 'fg_rock_formation', x: 0, y: H - 1, flipX: false },
      { type: 'fg_rock_formation', x: W - 2, y: H - 1, flipX: true },
...
function buildRoom16() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'gravel_patch', x: 44, y: f },
      { type: 'saw_blade', x: 14, y: 8, axis: 'x', range: 128, speed: 1.3, phase: 0 },
      { type: 'saw_blade', x: 38, y: 14, axis: 'x', range: 96, speed: 1.1, phase: 2.0 },
      { type: 'fireball_shooter', x: 1, y: 6, dir: 'right', interval: 1800 },
      { type: 'fireball_shooter', x: 53, y: 12, dir: 'left', interval: 2000 },
      { type: 'fireball_shooter', x: 1, y: 16, dir: 'right', interval: 2600 },
      { type: 'floor_spikes', x: 12, y: 19, onTime: 1000, offTime: 1400, phase: 0 },
      { type: 'floor_spikes', x: 26, y: 19, onTime: 1000, offTime: 1400, phase: 350 },
      { type: 'floor_spikes', x: 42, y: 19, onTime: 1000, offTime: 1400, phase: 700 },
      { type: 'flame_jet', x: 20, y: 19, dir: 'up', onTime: 1200, offTime: 1200, phase: 0 },
      { type: 'flame_jet', x: 48, y: 2, dir: 'down', onTime: 1000, offTime: 1600, phase: 400 }
    ],
    foreground: [
      { type: 'fg_rock_formation', x: 0, y: H - 1, flipX: false },
      { type: 'fg_rock_formation', x: W - 2, y: H - 1, flipX: true },
...
function buildRoom17() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'crawler', x: 8, y: f },
      { type: 'crawler', x: 36, y: f },
      { type: 'crawler', x: 13, y: 14 },
      { type: 'crawler', x: 21, y: 12 },
      { type: 'flyer', x: 9, y: 6 },
      { type: 'flyer', x: 22, y: 4 },
      { type: 'flyer', x: 33, y: 6 },
      { type: 'flyer', x: 15, y: 9 },
      ...
      { type: 'saw_blade', x: 22, y: 10, axis: 'y', range: 80, speed: 1.4, phase: 0 },
      { type: 'fireball_shooter', x: 1, y: 10, dir: 'right', interval: 1800 },
      { type: 'fireball_shooter', x: 42, y: 6, dir: 'left', interval: 2000 },
      { type: 'floor_spikes', x: 10, y: 21, onTime: 900, offTime: 1500, phase: 0 },
      { type: 'floor_spikes', x: 24, y: 21, onTime: 900, offTime: 1500, phase: 450 },
      { type: 'floor_spikes', x: 36, y: 21, onTime: 900, offTime: 1500, phase: 900 },
      { type: 'flame_jet', x: 16, y: 21, dir: 'up', onTime: 1100, offTime: 1300, phase: 0 },
      { type: 'flame_jet', x: 32, y: 2, dir: 'down', onTime: 1200, offTime: 1200, phase: 500 }
    ],
    foreground: [
      { type: 'fg_rock_formation', x: 0, y: H - 1, flipX: false },
      { type: 'fg_rock_formation', x: W - 2, y: H - 1, flipX: true }
...
function buildRoom18() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'saw_blade', x: 16, y: 8, axis: 'x', range: 128, speed: 1.3, phase: 0 },
      { type: 'saw_blade', x: 36, y: 14, axis: 'y', range: 72, speed: 1.2, phase: 1.5 },
      { type: 'fireball_shooter', x: 1, y: 8, dir: 'right', interval: 1800 },
      { type: 'fireball_shooter', x: 48, y: 14, dir: 'left', interval: 2000 },
      ...
      { type: 'flame_jet', x: 22, y: 19, dir: 'up', onTime: 1300, offTime: 1100, phase: 0 },
      { type: 'flame_jet', x: 38, y: 2, dir: 'down', onTime: 1100, offTime: 1300, phase: 400 }
    ],
    foreground: [
      { type: 'fg_rock_formation', x: 0, y: H - 1, flipX: false },
      { type: 'fg_rock_formation', x: W - 2, y: H - 1, flipX: true },
...
function buildRoom19() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'vine', x: 14, y: 1 },
      { type: 'fireball_shooter', x: 1, y: 6, dir: 'right', interval: 1800 },
      { type: 'fireball_shooter', x: 22, y: 14, dir: 'left', interval: 2000 },
      { type: 'fireball_shooter', x: 1, y: 22, dir: 'right', interval: 2200 },
      { type: 'floor_spikes', x: 12, y: 27, onTime: 800, offTime: 1400, phase: 0 },
      { type: 'saw_blade', x: 12, y: 10, axis: 'y', range: 64, speed: 1.4, phase: 0 },
      { type: 'flame_jet', x: 18, y: 4, dir: 'down', onTime: 1200, offTime: 1200, phase: 0 },
      { type: 'flame_jet', x: 6, y: 18, dir: 'up', onTime: 1000, offTime: 1400, phase: 300 }
    ],
    foreground: [
      { type: 'fg_rock_formation', x: 0, y: H - 1, flipX: false },
      { type: 'fg_rock_formation_sm', x: W - 2, y: H - 1, flipX: true },
...
function buildRoom20() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'hanging_moss', x: 18, y: 2 },
      { type: 'hanging_moss', x: 38, y: 2 },
      { type: 'saw_blade', x: 14, y: 6, axis: 'x', range: 144, speed: 1.4, phase: 0 },
      { type: 'saw_blade', x: 40, y: 14, axis: 'x', range: 112, speed: 1.2, phase: 2.0 },
      { type: 'fireball_shooter', x: 1, y: 6, dir: 'right', interval: 1600 },
      { type: 'fireball_shooter', x: 53, y: 10, dir: 'left', interval: 1800 },
      { type: 'fireball_shooter', x: 1, y: 16, dir: 'right', interval: 2200 },
      { type: 'floor_spikes', x: 10, y: 19, onTime: 800, offTime: 1200, phase: 0 },
      { type: 'floor_spikes', x: 24, y: 19, onTime: 800, offTime: 1200, phase: 300 },
      { type: 'floor_spikes', x: 38, y: 19, onTime: 800, offTime: 1200, phase: 600 },
      { type: 'floor_spikes', x: 50, y: 19, onTime: 800, offTime: 1200, phase: 900 },
      { type: 'flame_jet', x: 18, y: 19, dir: 'up', onTime: 1200, offTime: 1000, phase: 0 },
      { type: 'flame_jet', x: 46, y: 2, dir: 'down', onTime: 1000, offTime: 1200, phase: 500 }
    ],
    foreground: [
      { type: 'fg_rock_formation', x: 0, y: H - 1, flipX: false },
      { type: 'fg_rock_formation', x: W - 2, y: H - 1, flipX: true },
...
function buildRoom21() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'hanging_moss', x: 20, y: 2 },
      { type: 'hanging_moss', x: 26, y: 2 },
      { type: 'saw_blade', x: 22, y: 8, axis: 'y', range: 96, speed: 1.5, phase: 0 },
      { type: 'saw_blade', x: 10, y: 16, axis: 'x', range: 80, speed: 1.3, phase: 1.0 },
      { type: 'fireball_shooter', x: 1, y: 8, dir: 'right', interval: 1600 },
      { type: 'fireball_shooter', x: 42, y: 14, dir: 'left', interval: 1800 },
      ...
      { type: 'flame_jet', x: 14, y: 21, dir: 'up', onTime: 1200, offTime: 1000, phase: 0 },
      { type: 'flame_jet', x: 30, y: 2, dir: 'down', onTime: 1000, offTime: 1200, phase: 300 },
      { type: 'flame_jet', x: 38, y: 21, dir: 'up', onTime: 1100, offTime: 1100, phase: 600 }
    ],
    foreground: [
      { type: 'fg_rock_formation', x: 0, y: H - 1, flipX: false },
      { type: 'fg_rock_formation', x: W - 2, y: H - 1, flipX: true }
...
function buildRoom22() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'mud_patch', x: 40, y: f },
      { type: 'saw_blade', x: 16, y: 6, axis: 'x', range: 128, speed: 1.5, phase: 0 },
      { type: 'saw_blade', x: 38, y: 14, axis: 'y', range: 80, speed: 1.3, phase: 1.5 },
      { type: 'fireball_shooter', x: 1, y: 6, dir: 'right', interval: 1600 },
      { type: 'fireball_shooter', x: 48, y: 12, dir: 'left', interval: 1800 },
      { type: 'fireball_shooter', x: 1, y: 16, dir: 'right', interval: 2200 },
      ...
      { type: 'flame_jet', x: 20, y: 19, dir: 'up', onTime: 1200, offTime: 1000, phase: 0 },
      { type: 'flame_jet', x: 34, y: 2, dir: 'down', onTime: 1000, offTime: 1200, phase: 400 }
    ],
    foreground: [
      { type: 'fg_rock_formation', x: 0, y: H - 1, flipX: false },
      { type: 'fg_rock_formation', x: W - 2, y: H - 1, flipX: true },
...
function buildRoom23() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'fireball_shooter', x: 1, y: 6, dir: 'right', interval: 1600 },
      { type: 'fireball_shooter', x: 22, y: 14, dir: 'left', interval: 1800 },
      { type: 'fireball_shooter', x: 1, y: 22, dir: 'right', interval: 2000 },
      { type: 'floor_spikes', x: 12, y: 29, onTime: 700, offTime: 1200, phase: 0 },
      { type: 'saw_blade', x: 12, y: 10, axis: 'y', range: 80, speed: 1.5, phase: 0 },
      { type: 'flame_jet', x: 18, y: 4, dir: 'down', onTime: 1100, offTime: 1100, phase: 0 },
      { type: 'flame_jet', x: 6, y: 16, dir: 'up', onTime: 1000, offTime: 1200, phase: 300 },
      { type: 'flame_jet', x: 18, y: 24, dir: 'down', onTime: 1200, offTime: 1000, phase: 600 }
    ],
    foreground: [
      { type: 'fg_mushroom_large', x: 0, y: H - 1, flipX: false },
      { type: 'fg_rock_formation_sm', x: W - 2, y: H - 1, flipX: true },
...
function buildRoom24() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'hanging_moss', x: 16, y: 2 },
      { type: 'hanging_moss', x: 36, y: 2 },
      { type: 'saw_blade', x: 12, y: 6, axis: 'x', range: 144, speed: 1.5, phase: 0 },
      { type: 'saw_blade', x: 36, y: 12, axis: 'x', range: 128, speed: 1.3, phase: 2.0 },
      { type: 'saw_blade', x: 48, y: 16, axis: 'y', range: 64, speed: 1.4, phase: 1.0 },
      { type: 'fireball_shooter', x: 1, y: 6, dir: 'right', interval: 1400 },
      { type: 'fireball_shooter', x: 53, y: 10, dir: 'left', interval: 1600 },
      { type: 'fireball_shooter', x: 1, y: 16, dir: 'right', interval: 2000 },
      { type: 'floor_spikes', x: 10, y: 19, onTime: 700, offTime: 1000, phase: 0 },
      { type: 'floor_spikes', x: 22, y: 19, onTime: 700, offTime: 1000, phase: 250 },
      { type: 'floor_spikes', x: 34, y: 19, onTime: 700, offTime: 1000, phase: 500 },
      { type: 'floor_spikes', x: 46, y: 19, onTime: 700, offTime: 1000, phase: 750 },
      { type: 'flame_jet', x: 18, y: 19, dir: 'up', onTime: 1200, offTime: 800, phase: 0 },
      { type: 'flame_jet', x: 40, y: 2, dir: 'down', onTime: 1000, offTime: 1000, phase: 400 },
      { type: 'flame_jet', x: 28, y: 19, dir: 'up', onTime: 1100, offTime: 900, phase: 700 }
    ],
    foreground: [
      { type: 'fg_mushroom_large', x: 0, y: H - 1, flipX: false },
      { type: 'fg_rock_formation', x: W - 2, y: H - 1, flipX: true },
...
function buildRoom25() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'vine', x: 32, y: 2 },
      { type: 'saw_blade', x: 22, y: 8, axis: 'y', range: 96, speed: 1.5, phase: 0 },
      { type: 'saw_blade', x: 10, y: 16, axis: 'x', range: 80, speed: 1.4, phase: 1.0 },
      { type: 'fireball_shooter', x: 1, y: 8, dir: 'right', interval: 1400 },
      { type: 'fireball_shooter', x: 42, y: 14, dir: 'left', interval: 1600 },
      { type: 'floor_spikes', x: 8, y: 21, onTime: 700, offTime: 1100, phase: 0 },
      { type: 'floor_spikes', x: 20, y: 21, onTime: 700, offTime: 1100, phase: 350 },
      { type: 'floor_spikes', x: 34, y: 21, onTime: 700, offTime: 1100, phase: 700 },
      { type: 'flame_jet', x: 14, y: 21, dir: 'up', onTime: 1100, offTime: 900, phase: 0 },
      { type: 'flame_jet', x: 30, y: 2, dir: 'down', onTime: 1000, offTime: 1000, phase: 300 }
    ],
    foreground: [
      { type: 'fg_mushroom_large', x: 0, y: H - 1, flipX: false },
      { type: 'fg_rock_formation', x: W - 2, y: H - 1, flipX: true }
...
function buildRoom26() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'mud_patch', x: 18, y: f },
      { type: 'mud_patch', x: 44, y: f },
      { type: 'saw_blade', x: 14, y: 6, axis: 'x', range: 128, speed: 1.5, phase: 0 },
      { type: 'saw_blade', x: 36, y: 14, axis: 'y', range: 80, speed: 1.4, phase: 1.5 },
      { type: 'fireball_shooter', x: 1, y: 6, dir: 'right', interval: 1400 },
      { type: 'fireball_shooter', x: 48, y: 10, dir: 'left', interval: 1600 },
      { type: 'fireball_shooter', x: 1, y: 16, dir: 'right', interval: 2000 },
      { type: 'floor_spikes', x: 10, y: 19, onTime: 600, offTime: 1000, phase: 0 },
      { type: 'floor_spikes', x: 24, y: 19, onTime: 600, offTime: 1000, phase: 300 },
      { type: 'floor_spikes', x: 40, y: 19, onTime: 600, offTime: 1000, phase: 600 },
      { type: 'flame_jet', x: 18, y: 19, dir: 'up', onTime: 1200, offTime: 800, phase: 0 },
      { type: 'flame_jet', x: 32, y: 2, dir: 'down', onTime: 1000, offTime: 1000, phase: 300 },
      { type: 'flame_jet', x: 44, y: 19, dir: 'up', onTime: 1100, offTime: 900, phase: 600 }
    ],
    foreground: [
      { type: 'fg_rock_formation', x: 0, y: H - 1, flipX: false },
      { type: 'fg_rock_formation', x: W - 2, y: H - 1, flipX: true },
...
function buildRoom27() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'fireball_shooter', x: 1, y: 6, dir: 'right', interval: 1400 },
      { type: 'fireball_shooter', x: 24, y: 12, dir: 'left', interval: 1600 },
      { type: 'fireball_shooter', x: 1, y: 20, dir: 'right', interval: 1800 },
      { type: 'fireball_shooter', x: 24, y: 26, dir: 'left', interval: 2000 },
      { type: 'floor_spikes', x: 12, y: 29, onTime: 600, offTime: 1000, phase: 0 },
      { type: 'saw_blade', x: 13, y: 10, axis: 'y', range: 96, speed: 1.5, phase: 0 },
      { type: 'flame_jet', x: 8, y: 4, dir: 'down', onTime: 1100, offTime: 900, phase: 0 },
      { type: 'flame_jet', x: 18, y: 16, dir: 'up', onTime: 1000, offTime: 1000, phase: 300 },
      { type: 'flame_jet', x: 8, y: 24, dir: 'down', onTime: 1200, offTime: 800, phase: 600 }
    ],
    foreground: [
      { type: 'fg_rock_formation', x: 0, y: H - 1, flipX: false },
      { type: 'fg_crystal_large', x: W - 1, y: H - 1, flipX: true },
...
function buildRoom28() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'saw_blade', x: 14, y: 6, axis: 'x', range: 144, speed: 1.6, phase: 0 },
      { type: 'saw_blade', x: 38, y: 14, axis: 'x', range: 128, speed: 1.4, phase: 2.0 },
      { type: 'saw_blade', x: 26, y: 20, axis: 'y', range: 64, speed: 1.3, phase: 1.0 },
      { type: 'fireball_shooter', x: 1, y: 6, dir: 'right', interval: 1200 },
      { type: 'fireball_shooter', x: 53, y: 10, dir: 'left', interval: 1400 },
      { type: 'fireball_shooter', x: 1, y: 18, dir: 'right', interval: 1800 },
      { type: 'floor_spikes', x: 10, y: 23, onTime: 600, offTime: 900, phase: 0 },
      { type: 'floor_spikes', x: 22, y: 23, onTime: 600, offTime: 900, phase: 200 },
      { type: 'floor_spikes', x: 34, y: 23, onTime: 600, offTime: 900, phase: 400 },
      { type: 'floor_spikes', x: 46, y: 23, onTime: 600, offTime: 900, phase: 600 },
      { type: 'flame_jet', x: 18, y: 23, dir: 'up', onTime: 1200, offTime: 800, phase: 0 },
      { type: 'flame_jet', x: 30, y: 2, dir: 'down', onTime: 1000, offTime: 1000, phase: 300 },
      { type: 'flame_jet', x: 42, y: 23, dir: 'up', onTime: 1100, offTime: 900, phase: 600 }
    ],
    foreground: [
      { type: 'fg_rock_formation', x: 0, y: H - 1, flipX: false },
      { type: 'fg_rock_formation', x: W - 2, y: H - 1, flipX: true },
...
function buildRoom29() {
  ...
  return {
    ...
    objects: [
      ...
      { type: 'hanging_moss', x: 22, y: 2 },
      { type: 'hanging_moss', x: 28, y: 2 },
      { type: 'saw_blade', x: 14, y: 6, axis: 'x', range: 128, speed: 1.6, phase: 0 },
      { type: 'saw_blade', x: 34, y: 14, axis: 'y', range: 80, speed: 1.5, phase: 1.5 },
      { type: 'fireball_shooter', x: 1, y: 6, dir: 'right', interval: 1200 },
      { type: 'fireball_shooter', x: 46, y: 10, dir: 'left', interval: 1400 },
      { type: 'fireball_shooter', x: 1, y: 16, dir: 'right', interval: 1800 },
      { type: 'floor_spikes', x: 10, y: 19, onTime: 500, offTime: 900, phase: 0 },
      { type: 'floor_spikes', x: 22, y: 19, onTime: 500, offTime: 900, phase: 200 },
      { type: 'floor_spikes', x: 36, y: 19, onTime: 500, offTime: 900, phase: 400 },
      { type: 'flame_jet', x: 18, y: 19, dir: 'up', onTime: 1100, offTime: 700, phase: 0 },
      { type: 'flame_jet', x: 28, y: 2, dir: 'down', onTime: 1000, offTime: 800, phase: 300 },
      { type: 'flame_jet', x: 40, y: 19, dir: 'up', onTime: 1200, offTime: 600, phase: 600 }
    ],
    foreground: [
      { type: 'fg_rock_formation', x: 0, y: H - 1, flipX: false },
      { type: 'fg_rock_formation', x: W - 2, y: H - 1, flipX: true },
